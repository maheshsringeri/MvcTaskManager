...
namespace MvcTaskManager.Services
{
    public class UsersService : IUsersService
    {
        ...
        public UsersService(ApplicationUserManager applicationUserManager, ApplicationSignInManager applicationSignInManager
                        , IOptions<AppSettings> appSettings, ApplicationDbContext db)
        {
        ...
        public async Task<ApplicationUser> Register(SignUpViewModel signUpViewModel)
        {
            ...
            if (result.Succeeded)
            {
                var newUser = await _applicationUserManager.FindByNameAsync(signUpViewModel.Email);
                var RoleStatus = await _applicationUserManager.AddToRoleAsync(newUser, "Employee");
